...
export const CATEGORY_DETAILS: Record<number, CategoryDetail> = {
  1: {
    ...
    subCategories: [
      { title: 'ขนาดความจุ (ลิตร)', items: [
          '100', '200', '300', '330', '400', '500', '550', '600', '620', '700', '750', '800', '900', '1000', '1050',
          '1200', '1500', '2000', '2200', '2500', '3000', '4000', '5000', '6000', '8000', '10000', '11500', '12000', '16500'
        ].map(s => `${s} ลิตร`)
      },
      { title: 'แบรนด์ยอดนิยม', items: ['DOS', 'WAVE', 'Safe', 'P&S'] },
      { title: 'สี', items: ['สีน้ำเงิน', 'สีเขียว', 'สีทราย', 'สีแกรนิต', 'สีเทา'] }
    ],
  ...
  2: {
    ...
    subCategories: [
      { title: 'แบรนด์ชั้นนำ', items: [
        { label: 'ถังเก็บน้ำใต้ดิน PE WAVE', href: '/index.php?rt=product/category&path=716_18' },
        'ถังเก็บน้ำใต้ดิน PE Safe', 
        'ถังเก็บน้ำใต้ดิน PE P&S', 
        'ถังเก็บน้ำใต้ดิน PE DOS'
      ] }
    ],
